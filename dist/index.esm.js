...
var useKeyboardNavigation = function (layout, onKeyPress) {
    var _a = useState(null), focusedKey = _a[0], setFocusedKey = _a[1];
...
var useDiacriticState = function (inputText) {
    var _a = useState(false), canApplyDakuten = _a[0], setCanApplyDakuten = _a[1];
    var _b = useState(false), canApplyHandakuten = _b[0], setCanApplyHandakuten = _b[1];
    var _c = useState(false), canApplyKomoji = _c[0], setCanApplyKomoji = _c[1];
    var updateDiacriticState = useCallback(function (text) {
        if (text.length > 0) {
...
var HiraganaKeyboard = function (_a) {
    ...
    var _b = useState(null); _b[0]; var setActiveKey = _b[1];
    var _c = useState([]), candidates = _c[0], setCandidates = _c[1];
    var _d = useState(false), showCandidates = _d[0], setShowCandidates = _d[1];
    ...
    var combineCharacters = useCallback(function (text) {
    ...
    var preventDefaultHandler = useCallback(function (e) {
        e.preventDefault();
        e.stopPropagation();
    }, []);
    var handleTouchStart = useCallback(function (e, key) {
        e.preventDefault();
        if (key !== null) {
            handleKeyPress(key);
        }
    }, [handleKeyPress]);
    var handleCandidateSelect = useCallback(function (candidate) {
        if (disabled)
            return;
    ...
    var handleCandidateTouchStart = useCallback(function (e, candidate) {
        e.preventDefault();
    ...
    var keyboardContent = useMemo(function () {
        var currentLayout;
...
var HiraganaKeyboard$1 = React.memo(HiraganaKeyboard);
...
var TenkeyKeyboard$1 = React.memo(TenkeyKeyboard);
...
var useKeyboardLogic = function (value, onChange, keyboardType, kanaMode, maxLength, disabled) {
    ...
    var _b = useState([]), candidates = _b[0], setCandidates = _b[1];
    var debounceTimerRef = useRef(null);
    var candidateCacheRef = useRef(new Map());
    var debouncedFetchCandidates = useCallback(function (text) {
...
var useKeyboardState = function (autoFocus, disabled, onFocus, onBlur, onKeyDown) {
    var _a = useState(autoFocus), isFocused = _a[0], setIsFocused = _a[1];
    var _b = useState("hiragana"), kanaMode = _b[0], setKanaMode = _b[1];
    var _c = useState("upper"), alphabetCase = _c[0], setAlphabetCase = _c[1];
...
var VKeyboard = function (_a) {
    ...
    var systemTheme = useTheme().theme;
    ...
    var renderKey = useCallback(function (key) {
        if (key === "delete") {
            return jsxRuntime.exports.jsx(DeleteIcon, {}, "delete-icon");
        }
        return jsxRuntime.exports.jsx(React.Fragment, { children: key }, (key === null || key === void 0 ? void 0 : key.toString()) || "empty-key");
    }, []);
    var keyboardProps = useMemo(function () { return ({
        inputText: inputText,
        setInputText: setInputText,
...
var VirtualKeyboard = React.memo(VKeyboard);

export { VirtualKeyboard as VKeyboard };
